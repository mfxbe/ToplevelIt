all:
	...
	gcc $(wildcard src/*.c) build/extra/foreign-toplevel.c -g -Wall -Wextra -rdynamic -std=c2x $(shell pkg-config --libs --cflags gobject-2.0 wayland-client) -o build/ToplevelIt
